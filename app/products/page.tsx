...
import { Heart, Moon, Award, Leaf, Search } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-amber-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Categories Overview - Only show if no error */}
        {!error && (
          <div className="mt-16 bg-white rounded-2xl shadow-lg border-emerald-100 p-8">
            ...
            <div className="grid md:grid-cols-4 gap-6">
              ...
              >
                ...
                <p className="text-sm text-amber-700">Overall health support</p>
              </Link>
            </div>
          </div>
        )}
