...
import TeaBenefitFilter from "@/components/product-filters";
							...
							<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
								{products && products.length > 0 ? (
									products.map((product: any, index: number) => {
										...
										const displayPrice = smallestSize
											? smallestSize.price
											: product.price;
										const displaySize = smallestSize
											? `${smallestSize.size_grams}g`
											: "base size";
