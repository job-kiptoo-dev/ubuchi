...
import { Leaf, ArrowLeft, Package, Truck, CheckCircle, Clock } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-amber-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-emerald-700">Thank you for your order. We'll send you updates as it progresses.</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        {/* Back Button */}
        <Link href="/orders" className="inline-flex items-center text-emerald-700 hover:text-emerald-800 mb-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-amber-700 mt-1">Placed on {new Date(order.created_at).toLocaleDateString()}</p>
                  </div>
                ...
                {order.order_items.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <h4 className="font-semibold text-emerald-800">{item.products.name}</h4>
                      <p className="text-sm text-amber-700 line-clamp-2">{item.products.description}</p>
                      <div className="flex items-center gap-4 mt-2">
                        <span className="text-sm text-amber-700">Quantity: {item.quantity}</span>
                        <span className="text-sm text-amber-700">${Number.parseFloat(item.price).toFixed(2)} each</span>
                      </div>
                    </div>
                    <div className="text-right">
            ...
            {order.shipping_address && (
              <Card className="bg-white shadow-lg border-emerald-100">
                <CardHeader>
                  <CardTitle className="text-emerald-800">Shipping Address</CardTitle>
                </CardHeader>
                <CardContent>
            ...
            <Card className="bg-white shadow-lg border-emerald-100 sticky top-24">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="bg-emerald-50 rounded-lg p-4 mt-6">
                  <h4 className="font-semibold text-emerald-800 mb-3">Order Status</h4>
                ...
                <div className="space-y-2 pt-4">
                  {order.status === "delivered" && (
                    <Button className="w-full bg-emerald-600 hover:bg-emerald-700">Reorder Items</Button>
                  )}
                  <Link href="/products">
                    <Button variant="outline" className="w-full border-emerald-600 text-emerald-600 bg-transparent">
                      Continue Shopping
                    </Button>
                  </Link>
                </div>
